$(function () {
    $.widget("panel.selectPanel", $.dock.panel, {
        ...
        _create: function () {
            ...
            var dropdown = $("<div>", {
                ...
                $("<button>", {
                    ...
                    class: "selector-btn-wrapper",
                }).append($("<span>", {
                    class: "selector-btn-content",
                }).append(this.options.buttonContent)).append($("<span>", {
                    class: "glyphicon glyphicon-chevron-down"
                }))));//.appendTo(this.panelBody);
            
            this._addRow($('<div>', { class: 'col-sm-12' }).append(dropdown));
            ...
            //$( '<div>', { 'id': 'layerList' } ).appendTo( this );
        ...
        addSelectOption: function (optionId, optionContent) {
            var self = this;
            $("<li>").append(
                $("<a>").append(optionContent).click(function() {
